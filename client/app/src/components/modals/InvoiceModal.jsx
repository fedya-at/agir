...
const InvoiceDetails = ({
  ...
  return (
    <Grid container spacing={3}>
      ...
      {/* Updated Invoice Summary with Labor Cost */}
      <Grid item xs={12}>
        <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
          <Box sx={{ width: 300 }}>
            ...
            >
              ...
              <Typography>${laborCost.toFixed(2)}</Typography>
            </Box>
            <Box
              sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}
            >
              <Typography>Parts Cost:</Typography>
              <Typography>${partsCost.toFixed(2)}</Typography>
            </Box>
            <Box
              sx={{ display: "flex", justifyContent: "space-between", mb: 1 }}
            >
            ...
            >
              ...
              <Typography>${tvaAmount.toFixed(2)}</Typography>
            </Box>
            <Divider sx={{ my: 1 }} />
